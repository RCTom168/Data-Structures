...
class Queue:
    ...
    def enqueue(self, value):
        self.size += 1 # Enqueue means adding something
        self.storage.add_to_tail((value)) # Because this is a queue, we add to the end

    def dequeue(self):
        if self.size != 0: # You can't dequeue an empty list
            self.size -= 1 # Dequeue means to remove something
